...
public class TashchezHigayonMenu extends Activity {
    private Activity activity = this;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tashchez_higayon_menu);
        ...
        menuGrid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        intent = new Intent(TashchezHigayonMenu.this, TashchezHigayonUI.class);
    ...
    private void addMenuItems(ArrayList<TypeMenuCell> menuCellArr)
    {
        ...
        int mainMenuPic = R.drawable.ic_tashchez_higayon;
